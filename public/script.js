const translations = {
    en: {
        ...
        contact: "Contact",
        courses: "Courses",
        aboutText: "Experienced QA Engineer with a focus on details and quality assurance processes. Specialized in web application testing and test documentation.",
    ...
    cs: {
        ...
        contact: "Kontakt",
        courses: "Kurzy",
        aboutText: "Zkušený QA inženýr se zaměřením na detaily a procesy zajištění kvality. Specializace na testování webových aplikací a testovací dokumentaci.",
        project1Title: "127 ZBIR",
    ...
    uk: {
        ...
        contact: "Контакти",
        courses: "Курси",
        aboutText: "Досвідчений QA інженер з фокусом на деталях та процесах забезпечення якості. Спеціалізуюся на тестуванні веб-додатків та тестовій документації.",
    ...
    ru: {
        ...
        contact: "Контакты",
        courses: "Курсы",
        aboutText: "Опытный QA инженер с фокусом на деталях и процессах обеспечения качества. Специализируюсь на тестировании веб-приложений и тестовой документации.",
